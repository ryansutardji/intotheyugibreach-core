...
const UNIT_DATABASE = {
  agido: {
    ...
    attribute: 'EARTH',
    side: 'rival',
    effect: 'Once per turn, grants a random ally a random bonus between +5 and +20 ATK for the remainder of the turn.',
  },
  amphibian_beast: {
    ...
    attribute: 'WATER',
    side: 'rival',
    effect: 'Takes 50% less damage from Aqua and Fish-type attackers, and reflects 20% of damage taken from them back at the attacker.',
  },
  baby_dragon: {
    name: 'Baby Dragon',
    cost: 3,
  ...
  great_angus: {
    ...
    attribute: 'FIRE',
    side: 'rival',
    effect: 'Deals 30% bonus damage on the first attack it makes each battle.',
  },
  harpie_lady_sisters: {
    ...
    attribute: 'WIND',
    side: 'rival',
    effect: 'Grants +2 ATK to all adjacent allies, and +5 ATK instead to adjacent WIND-attribute allies.',
  },
  hinotama_soul: {
    name: 'Hinotama Soul',
    cost: 2,
    ...
    attribute: 'FIRE',
    side: 'rival',
    effect: 'Can detonate instead of attacking, dealing 15 damage to all enemies within 1 tile but destroying itself.',
  },
  horus_the_black_flame_dragon_lv6: {
    ...
    attribute: 'FIRE',
    side: 'rival',
    effect: 'Once per battle, can sacrifice itself to instantly destroy any one enemy unit on the board.',
  },
  ...
  molten_zombie: {
    ...
    attribute: 'FIRE',
    side: 'rival',
    effect: "The first time it's destroyed each battle, revives at half HP and inflicts 10 burn damage to all adjacent enemies.",
  },
  mystical_elf: {
    name: 'Mystical Elf',
    cost: 4,
  ...
  petit_moth: {
    ...
    attribute: 'EARTH',
    side: 'rival',
    effect: 'Every 3 rounds, permanently gains +1 ATK and +5 HP, growing stronger the longer the battle lasts.',
  },
  princess_of_tsurugi: {
  ...
  skelengel: {
    ...
    attribute: 'LIGHT',
    side: 'rival',
    effect: 'Heals all allies for 5 HP at the start of the battle.',
  },
  skull_red_bird: {
    name: 'Skull Red Bird',
    cost: 4,
    ...
    attribute: 'WIND',
    side: 'rival',
    effect: 'Gains +3 ATK permanently whenever an adjacent unit, ally or enemy, is destroyed.',
  },
  sky_scout: {
    name: 'Sky Scout',
    cost: 4,
  ...
  the_legendary_fisherman: {
    ...
    attribute: 'WATER',
    side: 'rival',
    effect: 'Cannot be attacked by enemies at range 2 or greater — only adjacent enemies can target it.',
  },
  time_wizard: {
    name: 'Time Wizard',
    cost: 2,
  ...
  white_dolphin: {
    ...
    attribute: 'WATER',
    side: 'rival',
    effect: 'Has a 25% chance to fully evade any attack, taking no damage.',
  },
};
